...
internal const OPTIONS:Array = [ 'time', 'year', 'month', 'date', 'hours', 'minutes', 'seconds', 'milliseconds', 'ms' ];

internal const FIELDS:Object = { 'time': 'time', 'year': 'fullYear', 'month': 'month', 'date': 'date', 'hours': 'hours', 'minutes': 'minutes', 'seconds': 'seconds', 'milliseconds': 'milliseconds', 'ms': 'milliseconds' };
